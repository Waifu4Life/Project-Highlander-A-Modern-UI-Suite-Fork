...
local function crystalRequire(name)
  local src = assert(mod:read(name .. ".lua"), name .. ".lua missing")
  return assert(load(src, "@crystal/" .. name))()
end
local speciesMap = crystalRequire("species_map")
local animationData = crystalRequire("animation_data")
...
return function()
  ...
  -- last.
  local optionScreen = crystalRequire("options_screen")
  ...
  mod.log:info(
    "Crystal Animated Sprites with Shiny Visuals v2.0.3 loaded")
end
