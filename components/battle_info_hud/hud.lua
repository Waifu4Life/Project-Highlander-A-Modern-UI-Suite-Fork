return function(mod)
  ...
  local function drawEnemyMeter(battle, ink, markColor, dx, dy)
    Meters.draw(battle.data, battle.enemy, "HP", 32 + (dx or 0), 17 + (dy or 0), 48, enemyHpCounter(), ink, markColor)
  end
  ...
  local function renderWide(battle)
    ...
    if enemyVisible(battle) then
      ...
      Meters.draw(battle.data, battle.enemy, "HP", 24, 17, 104, enemyHpCounter())
